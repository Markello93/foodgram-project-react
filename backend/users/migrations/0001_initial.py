# Generated by Django 3.2.18 on 2023-03-11 16:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'user'), ('user', 'anonymous'), ('admin', 'admin')], default='user', max_length=15, verbose_name='Роль пользователя')),
